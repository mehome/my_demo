...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/workplace3/panther/openwrt/staging_dir/host/bin/grep -E"}
	: ${FGREP="/workplace3/panther/openwrt/staging_dir/host/bin/grep -F"}
	: ${GREP="/workplace3/panther/openwrt/staging_dir/host/bin/grep"}
	: ${SED="/workplace3/panther/openwrt/staging_dir/host/bin/sed"}
fi
