...
#define __GMP_CFLAGS "-O2 -I/workplace3/panther.git/openwrt/staging_dir/host/include -I/workplace3/panther.git/openwrt/staging_dir/host/usr/include -DNO_ASM"
