...
public:
    ...
    duerOSDcsSDK::sdkInterfaces::MediaPlayerStatus setSource(const std::string& tts_content, bool repeat) override;
...
private:
    ...
    std::shared_ptr<LocalSynthesizerPlayer> m_tts_player;
