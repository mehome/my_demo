...
//                                  separated by comma.
// @param [in]  apply_frontend     is true, then apply frontend audio processing;
// 				   otherwise turns the audio processing off.

void SnowboyInit(const char* resource_filename, const char* model_str, const bool apply_frontend);
...
//                                 utterance or file.
int SnowboyRunDetection(const int16_t* const data,
