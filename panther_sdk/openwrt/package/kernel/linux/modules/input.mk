...
define KernelPackage/gpio-button-hotplug
  SUBMENU:=$(INPUT_MODULES_MENU)
  TITLE:=GPIO button plug
  KCONFIG:=CONFIG_GPIO_BUTTON_HOTPLUG=m
  FILES:=$(LINUX_DIR)/arch/mips/panther/base/gpio-button-hotplug.ko
endef

define KernelPackage/gpio-button-hotplug/description
  gpio-button-hotplug.ko in /lib/modules
endef
