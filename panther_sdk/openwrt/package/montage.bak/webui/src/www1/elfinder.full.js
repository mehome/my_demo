...
(function($) {
	...
	/*
	 * File: config/demo2/elfinder/js/elFinder.js
	 */
	...
	window.elFinder = function(node, opts) {
		...
		this.request = function(options) {
			...
			success(JSON.parse(wdk.cliCmd("elfinder2 " + jQuery.param(options.data))));
	...
	/*
	 * File: config/demo2/elfinder/js/elFinder.version.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/jquery.elfinder.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/elFinder.options.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/elFinder.history.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/elFinder.command.js
	 */
	...
	elFinder.prototype.command = function(fm) {
		...
		this.hashes = function(hashes) {
			return hashes ? $.map($.isArray(hashes) ? hashes : [hashes], function(hash) {
	...
	/*
	 * File: config/demo2/elfinder/js/elFinder.resources.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/jquery.dialogelfinder.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/i18n/elfinder.en.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/button.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/contextmenu.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/cwd.js
	 */
		...
		this.not('.elfinder-cwd').each(function() {
			...
			var
				...
				render = function() {
					...
					while ((!last.length || last.position().top <= wrapper.height() + wrapper.scrollTop() + fm.options.showThreshold) && (files = buffer.splice(0, fm.options.showFiles)).length) {
				...
				content = function(files, any) {
					...
					if (options.oldSchool && phash && !query) {
						var parent = $.extend(true, {}, fm.file(phash), {
							name: '..',
							mime: 'directory'
						});
			...
			if (fm.dragUpload) {
				...
				wrapper[0].addEventListener('drop', function(e) {
					...
					e.dataTransfer && e.dataTransfer.files && e.dataTransfer.files.length && fm.exec('upload', {
						files: e.dataTransfer.files
					}) //fm.upload({files : e.dataTransfer.files});
				}, false);
			}
			...
			fm
				...
				.add(function(e) {
					var phash = fm.cwd().hash,
						files = query ? $.map(e.data.added || [], function(f) {
	...
	/*
	 * File: config/demo2/elfinder/js/ui/dialog.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/navbar.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/overlay.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/panel.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/path.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/places.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/searchbutton.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/sortbutton.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/stat.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/toolbar.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/tree.js
	 */
			...
			var c = 'class',
				...
				findSibling = function(subtree, dir) {
					...
					while (node.length) {
						...
						if ((info = fm.file(fm.navId2Hash(node.children('[id]').attr('id')))) && dir.name.toLowerCase().localeCompare(info.name.toLowerCase()) < 0) {
							return node;
						}
						node = node.next();
					}
				...
				.delegate('.' + navdir + '.' + collapsed + ' .' + arrow, 'click', function(e) {
					...
					if (link.is('.' + loaded)) {
						...
						fm.request({
							cmd: 'tree',
							target: fm.navId2Hash(link.attr('id'))
						})
							.done(function(data) {
			...
			.change(function(e) {
				...
				while (l--) {
					...
					if ((node = tree.find('#' + fm.navHash2Id(dir.hash))).length) {
						...
						if (dir.dirs && (isExpanded || isLoaded) && (node = tree.find('#' + fm.navHash2Id(dir.hash))) && node.next('.' + subtree).children().length) {
	...
	/*
	 * File: config/demo2/elfinder/js/ui/uploadButton.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/viewbutton.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/ui/workzone.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/archive.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/back.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/copy.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/cut.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/download.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/duplicate.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/edit.js
	 */
	...
	elFinder.prototype.commands.edit = function() {
		var self = this,
			...
			filter = function(files) {
				return $.map(files, function(file) {
					return (file.mime.indexOf('text/') === 0 || $.inArray(file.mime, mimes) !== -1) && file.mime.indexOf('text/rtf') && (!self.onlyMimes.length || $.inArray(file.mime, self.onlyMimes) !== -1) && file.read && file.write ? file : null;
				});
			},
			...
			dialog = function(id, file, content) {
				...
				$.each(self.options.editors || [], function(i, editor) {
					if ($.inArray(file.mime, editor.mimes || []) !== -1 && typeof editor.load == 'function' && typeof editor.save == 'function') {
						ta.editor = {
							load: editor.load,
							save: editor.save,
		...
		this.exec = function(hashes) {
			...
			return list.length ? $.when.apply(null, list) : $.Deferred().reject();
		}

	}

	/*
	 * File: config/demo2/elfinder/js/commands/extract.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/forward.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/getfile.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/help.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/home.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/info.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/mkdir.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/mkfile.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/netmount.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/open.js
	 */
		...
		this.exec = function(hashes) {
			...
			while (cnt--) {
				...
				if (!(url = fm.url( /*file.thash || */ file.hash))) {
					url = fm.options.url;
					url = url + (url.indexOf('?') === -1 ? '?' : '&') + (fm.oldAPI ? 'cmd=open&current=' + file.phash : 'cmd=file') + '&target=' + file.hash;
				}
	...
	/*
	 * File: config/demo2/elfinder/js/commands/paste.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/quicklook.js
	 */
	...
	elFinder.prototype.commands.quicklook = function() {
		...
		.bind('update', function(e) {
			...
			if (file) {
				...
				info.html(
					tpl.replace(/\{value\}/, file.name) + tpl.replace(/\{value\}/, fm.mime2kind(file)) + (file.mime == 'directory' ? '' : tpl.replace(/\{value\}/, fm.formatSize(file.size))) + tpl.replace(/\{value\}/, fm.i18n('modify') + ': ' + fm.formatDate(file))
				)
		...
		this.window = $('<div class="ui-helper-reset ui-widget elfinder-quicklook" style="position:absolute"/>')
			...
			.bind('close', function(e) {
				...
				if (self.opened()) {
					...
					node.length ? win.animate(closedCss(node), 500, close) : close();
				}
			});
		...
		this.init = function() {
			...
			fm.one('load', function() {
				...
				self.change(function() {
					if (self.opened()) {
						self.value ? preview.trigger($.Event('update', {
							file: self.value
						})) : win.trigger('close');
					}
				});
	...
	/*
	 * File: config/demo2/elfinder/js/commands/quicklook.plugins.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/reload.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/rename.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/resize.js
	 */
						...
						.load(function() {
							...
							control.find('input,select').removeAttr('disabled')
								.filter(':text').keydown(function(e) {
									...
									if ((c >= 37 && c <= 40) || c == $.ui.keyCode.BACKSPACE || c == $.ui.keyCode.DELETE || (c == 65 && (e.ctrlKey || e.metaKey)) || c == 27) {
										return;
									}
	...
	(function($) {
		...
		$.cssHooks.transform = {
			get: function(elem, computed, extra) {
				var name = findProperty(elem.style, ['WebkitTransform', 'MozTransform', 'OTransform', 'msTransform', 'transform']);
	...
	/*
	 * File: config/demo2/elfinder/js/commands/rm.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/search.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/sort.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/up.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/upload.js
	 */
	...
	/*
	 * File: config/demo2/elfinder/js/commands/view.js
	 */
