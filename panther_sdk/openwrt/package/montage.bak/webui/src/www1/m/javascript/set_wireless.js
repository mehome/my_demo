...
function ScanResult() {
	...
	for (var i = 1; i <= total; i++) {
		...
		wdk.fill_form_entry(wdk.getById('entry' + i), str + '&id=' + i);
	}
	...
	if (Number(f.$wl_enable.checked)) {
		...
		switch (work_mode) {
			...
			case '6': // Station mode
				...
				wdk.cdbSet('$wl_bss_role2', WIFI_STA_ROLE + WIFI_MAT);
				sec_mode = wdk.getById('wl_sec_type').value;
				wdk.cdbSet('$wl_bss_role1', WIFI_NONE);
				break;
				/*--endif--*/
		}
...
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_WR--*/
// 	wdk.getById("w2").text = wdk.msg('Wireless Router');
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_WISP--*/
// 	wdk.getById("w3").text = wdk.msg('WISP');
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_RPT--*/
// 	wdk.getById("w4").text = wdk.msg('Repeater');
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_BRG--*/
// 	wdk.getById("w5").text = wdk.msg('Bridge');
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_3G--*/
// 	wdk.getById("w7").text = wdk.msg('3G');
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_P2P--*/
// 	wdk.getById("w8").text = wdk.msg('P2P');
// 	/*--endif--*/
// 	/*--ifdef CONFIG_OP_STA--*/
