...
public:
    ...
    void addActionMapping(const std::string& actName, soapfun fun, char action);
    ...
    */
	...
	unsigned int get_linkip() { return connectip;}
	void set_linkip(unsigned int ip) { connectip = ip;}
private:
    ...
    std::unordered_map<std::string, char> m_checks;
