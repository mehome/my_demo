...
int WIFIAudio_httpapi_retGetDeviceInfo(WAGC_pComParm pcomparm)
{
	...
	if(pcomparm == NULL)
	{
		...
		if(NULL == pstr)
		{
			...
			pstring = WIFIAudio_RealTimeInterface_newBuf(pstr);//将设备信息转换为json类型
...
int WIFIAudio_httpapi_retSetOneTouchConfigure(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		ret = WIFIAudio_SystemCommand_setOneTouchConfigure(pcomparm->Parameter.pOneTouchState->Value);
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retGetWakeupTimes(WAGC_pComParm pcomparm)
{
	int ret = 0;
	WARTI_pStr pstr = NULL;
	char *pstring = NULL;
	...
	if(pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_GetWakeupTimesTopStr();
		if (pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
...
int WIFIAudio_httpapi_retsetPlayerCmd_loopmode(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		ret = WIFIAudio_SystemCommand_setPlayerCmd_loopmode(pcomparm->Parameter.pSetPlayerCmd->Value);
...
int WIFIAudio_httpapi_retsetPlayerCmd_equalizer(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		ret = WIFIAudio_SystemCommand_setPlayerCmd_equalizer(pcomparm->Parameter.pSetPlayerCmd->Value);
...
int WIFIAudio_httpapi_retsetPlayerCmd_slave_channel(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		ret = WIFIAudio_SystemCommand_setPlayerCmd_slave_channel(pcomparm->Parameter.pSetPlayerCmd->Value);
...
int WIFIAudio_httpapi_retsetSSID(WAGC_pComParm pcomparm)
{
	...
	if((pcomparm == NULL) || (pcomparm->Parameter.pSSID == NULL) || (pcomparm->Parameter.pSSID->pSSID == NULL))
	{
		ret = -1;
	} else {
...
int WIFIAudio_httpapi_retsetNetwork(WAGC_pComParm pcomparm)
{
	...
	if((pcomparm == NULL) || (pcomparm->Parameter.pNetwork == NULL) || (pcomparm->Parameter.pNetwork->pPassword == NULL))
	{
		ret = -1;
	} else {
...
int WIFIAudio_httpapi_retsetShutdown(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		ret = WIFIAudio_SystemCommand_setShutdown(pcomparm->Parameter.pShutdown->Second);
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retxzxAction_setrt(WAGC_pComParm pcomparm)
{
	...
	if(pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_xzxAction_setrt(pcomparm->Parameter.pxzxAction->Value);
		if(ret == 0)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retxzxAction_normalrecord(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		ret = WIFIAudio_SystemCommand_xzxAction_normalrecord(pcomparm->Parameter.pxzxAction->Value);
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retxzxAction_micrecord(WAGC_pComParm pcomparm)
{
	...
	if(pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_xzxAction_micrecord(pcomparm->Parameter.pxzxAction->Value);
		printf("ret = %d\n",ret);
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");
...
int WIFIAudio_httpapi_retxzxAction_refrecord(WAGC_pComParm pcomparm)
{
	...
	if(pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_xzxAction_refrecord(pcomparm->Parameter.pxzxAction->Value);
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retxzxAction(WAGC_pComParm pcomparm)
{
	...
	if(NULL == pcomparm)
	{
		...
		switch(pcomparm->Parameter.pxzxAction->Attr)
		{
			...
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921MICRECORD:
				WIFIAudio_httpapi_retxzxAction_micrecord(pcomparm);
				break;
				
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921GETMICURL:
				WIFIAudio_httpapi_retxzxAction_getmicurl(pcomparm);
				break;
			
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921REFRECORD:
				WIFIAudio_httpapi_retxzxAction_refrecord(pcomparm);
				break;
				
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921GETREFURL:
			...
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_STOPMODERECORD:
				...
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_MICARRAYMICRECORD:		//远场录音1
				WIFIAudio_httpapi_retMicarrayRecord(pcomparm);			
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921DENOISERECORD:
				WIFIAudio_httpapi_retxzxAction_normalrecord(pcomparm);
				break;			
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_MICARRAYRECORDSTOP:	//远场录音3
				WIFIAudio_httpapi_retMicarrayStop(pcomparm);
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921RECORDSTOP:
				WIFIAudio_httpapi_retxzxAction_stopModeRecord(pcomparm);
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_MICARRAYRECORDFILE:
				WIFIAudio_httpapi_retMicarrayMic(pcomparm);
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921RECORDFILE:
				WIFIAudio_httpapi_retxzxAction_getmicurl(pcomparm);
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_MICARRAYREFRECORDFILE:
				WIFIAudio_httpapi_retMicarrayRef(pcomparm);
				break;	
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921REFRECORDFILE:
				WIFIAudio_httpapi_retxzxAction_getrefurl(pcomparm);
				break;	
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_MICARRAYDENOISERECORDFILE:
				WIFIAudio_httpapi_retMicarrayNormal(pcomparm);
				break;
			case WAGC_COMMAND_XZXACTIONATTR_TYPE_CX20921DENOISERECORDFILE:
				WIFIAudio_httpapi_retxzxAction_getnormalurl(pcomparm);
				break;			
			default:
				break;
...
int WIFIAudio_httpapi_retGetMicarrayInfo(WAGC_pComParm pcomparm)
{
	int ret = 0;
	char *pstring = NULL;
	WARTI_pStr pstr = NULL;
	...
	if(pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_GetMicarrayInfoTopStr();
		if(pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
		} else {
			pstring = WIFIAudio_RealTimeInterface_newBuf(pstr);	//将配置好的是数据配置成json数据格式
			WIFIAudio_RealTimeInterface_pStrFree(&pstr);		//释放掉pstr的数据
			if (pstring == NULL)
			{
				WIFIAudio_RetJson_retJSON("FAIL");
				ret = -1;
...
int WIFIAudio_httpapi_retMicarrayRecord(WAGC_pComParm pcomparm)
{
	int ret = 0;
	...
	if(pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_MicarrayRecord(pcomparm->Parameter.pxzxAction->Value);
		if (ret == 0)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retMicarrayNormal(WAGC_pComParm pcomparm)
{
	int ret = 0;
	char *pstring = NULL;
	WARTI_pStr pstr = NULL;
	...
	if(pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_MicarrayNormalTopStr();
		if (pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
...
int WIFIAudio_httpapi_retMicarrayMic(WAGC_pComParm pcomparm)
{
	int ret = 0;
	char *pstring = NULL;
	WARTI_pStr pstr = NULL;
	...
	if(pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_MicarrayMicTopStr();
		if (pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
...
int WIFIAudio_httpapi_retMicarrayRef(WAGC_pComParm pcomparm)
{
	int ret = 0;
	char *pstring = NULL;
	WARTI_pStr pstr = NULL;
	...
	if(pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_MicarrayRefTopStr();
		if (pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
...
int WIFIAudio_httpapi_retMicarrayStop(WAGC_pComParm pcomparm)
{
	int ret = 0;
	...
	if(pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_MicarrayStop();
		if (ret == 0)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retLogCaptureEnable(WAGC_pComParm pcomparm)
{
	int ret = 0;
	char *pstring = NULL;
	WARTI_pStr pstr = NULL;
	...
	if (pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_LogCaptureEnableTopStr();
		if (pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
...
int WIFIAudio_httpapi_retLogCaptureDisable(WAGC_pComParm pcomparm)
{
	int ret = 0;
	...
	if (pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_LogCaptureDisable();
		if (ret == 0)
		{
			WIFIAudio_RetJson_retJSON("OK");
		} else {
...
int WIFIAudio_httpapi_retGetTestMode(WAGC_pComParm pcomparm)
{
	int ret = 0;
	WARTI_pStr pstr = NULL;
	char *pstring = NULL;
	...
	if(pcomparm == NULL)
	{
		...
		pstr = WIFIAudio_SystemCommand_GetTestModeTopStr();
		if (pstr == NULL)
		{
			WIFIAudio_RetJson_retJSON("FAIL");
			ret = -1;
...
int WIFIAudio_httpapi_retPlayTestMusic(WAGC_pComParm pcomparm)
{
	int ret = 0;
	...
	if (pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_PlayTestMusic(pcomparm->Parameter.pPlayTestMusic->pURL);
...
int WIFIAudio_httpapi_retSdIsExist(WAGC_pComParm pcomparm)
{
	int ret = 0;
	if(pcomparm == NULL)
	{
	...
	{
		ret = WIFIAudio_SystemCommand_SdIsExist();
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");	
		}else{
...
int WIFIAudio_httpapi_retUSBIsExist(WAGC_pComParm pcomparm)
{
	int ret = 0;
	if(pcomparm == NULL)
	{
	...
	{
		ret = WIFIAudio_SystemCommand_USBIsExist();
		if(0 == ret)
		{
			WIFIAudio_RetJson_retJSON("OK");	
		}else{
...
int WIFIAudio_httpapi_retStopTestMusic(WAGC_pComParm pcomparm)
{
	int ret = 0;
	...
	if (pcomparm == NULL)
	{
		...
		ret = WIFIAudio_SystemCommand_StopTestMusic();
...
int main(int argc,char *argv[])
{
	...
	if (sscanf(data, "command=%s", Comment) != 1)//command=PlayTestMusic:http://10.10.10.170:36820/test_pink_noise.wav
	{
	} else {
		...
		if (pComParm != NULL)
		{
			switch (pComParm->Command)
			{
				...
				case WIFIAUDIO_GETCOMMAND_GETSDSTATUS:				//sd
					WIFIAudio_httpapi_retSdIsExist(pComParm);
					break;

				case WIFIAUDIO_GETCOMMAND_GETUSBSTATUS:				//USB
					WIFIAudio_httpapi_retUSBIsExist(pComParm);
					break;
				...
				case WIFIAUDIO_GETCOMMAND_GETBATTERYLEVEL:
					break;
				
				case WIFIAUDIO_GETCOMMAND_ISCHARGEPLUG:
					break;
				
				case WIFIAUDIO_GETCOMMAND_GETWAKEUPTIMES:
					WIFIAudio_httpapi_retGetWakeupTimes(pComParm);
					break;
				...
				case WIFIAUDIO_GETCOMMAND_SETSYNCHRONOUSCHANNEL:
					break;
				...
				case WIFIAUDIO_GETCOMMAND_GETTESTMODE:
					WIFIAudio_httpapi_retGetTestMode(pComParm);
					break;
				
				case WIFIAUDIO_GETCOMMAND_PLAYTESTMUSIC:
					WIFIAudio_httpapi_retPlayTestMusic(pComParm);
					break;
				
				case WIFIAUDIO_GETCOMMAND_STOPTESTMUSIC:
					WIFIAudio_httpapi_retStopTestMusic(pComParm);
					break;
				...
				case WIFIAUDIO_GETCOMMAND_GETMICARRAYINFO:
					WIFIAudio_httpapi_retGetMicarrayInfo(pComParm);	//远场录音1
					break;
					
				case WIFIAUDIO_GETCOMMAND_MICARRAYRECORD:
					//WIFIAudio_httpapi_retMicarrayRecord(pComParm);
					WIFIAudio_httpapi_retxzxAction(pComParm);		//远场录音2
					break;
					
				case WIFIAUDIO_GETCOMMAND_MICARRAYNORMAL:
					WIFIAudio_httpapi_retMicarrayNormal(pComParm);
					break;
					
				case WIFIAUDIO_GETCOMMAND_GETRECORDFILE:
				//	WIFIAudio_httpapi_retMicarrayMic(pComParm);
					WIFIAudio_httpapi_retxzxAction(pComParm);
					break;
					
				case WIFIAUDIO_GETCOMMAND_MICARRAYREF:
					WIFIAudio_httpapi_retxzxAction(pComParm);
				//	WIFIAudio_httpapi_retMicarrayRef(pComParm);
					break;
					
				case WIFIAUDIO_GETCOMMAND_MICARRAYSTOP:
					WIFIAudio_httpapi_retxzxAction(pComParm);	//远场录音3
				//	WIFIAudio_httpapi_retAllStop(pComParm);
					break;
				...
				case WIFIAUDIO_GETCOMMAND_GETCONEXANTVERSION:
					break;
				...
				case WIFIAUDIO_GETCOMMAND_LOGCAPTUREENABLE:
					WIFIAudio_httpapi_retLogCaptureEnable(pComParm);
					break;
					
				case WIFIAUDIO_GETCOMMAND_LOGCAPTUREDISABLE:
					WIFIAudio_httpapi_retLogCaptureDisable(pComParm);
					break;
