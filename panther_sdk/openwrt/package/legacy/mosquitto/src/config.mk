...
CLIENT_LDFLAGS:=$(LDFLAGS) -Wl,-rpath-link=$(STAGING_DIR)/usr/lib -L../lib ../lib/libmosquitto.so.${SOVERSION}
...
ifeq ($(WITH_TLS),yes)
	BROKER_LIBS:=$(BROKER_LIBS)  -Wl,-rpath-link=$(STAGING_DIR)/usr/lib -lcrypto -lssl
	LIB_LIBS:=$(LIB_LIBS)  -Wl,-rpath-link=$(STAGING_DIR)/usr/lib -lcrypto -lssl
