...
struct playlist {
	...
	void SendToTuring(PlayerControl &pc);
#endif
...
public:
	...
	bool GetDlna() const {
		return queue.dlna_pause;
	}
#endif

#ifdef MONTAGE_ENABLE_LINKIP
	uint32_t GetLinkip() const {
		return queue.linkip;
	}
#endif
...
#ifdef MONTAGE_ENABLE_DLNA_PAUSE
	void SetDlna(PlayerControl &pc, bool new_value);
#endif

#ifdef MONTAGE_ENABLE_LINKIP
	void SetLinkip(PlayerControl &pc, uint32_t linkip);
#endif
