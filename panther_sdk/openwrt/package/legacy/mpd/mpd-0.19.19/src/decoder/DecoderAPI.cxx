		    ...
		    bool seekable, SignedSongTime duration)
{
	...
	FormatDebug(decoder_domain, "iaudio_format=%s, oaudio_format=%s, seekable=%s",
		    audio_format_to_string(dc.in_audio_format, &af_string),
		    audio_format_to_string(dc.out_audio_format,&af_string),
		    seekable ? "true" : "false");
