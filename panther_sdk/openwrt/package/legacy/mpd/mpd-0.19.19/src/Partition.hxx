...
struct Partition final : private PlayerListener, private MixerListener {
	...
	void SetDlna(bool new_value) {
		playlist.SetDlna(pc, new_value);
	}
#endif

#ifdef MONTAGE_ENABLE_LINKIP
	void SetLinkip(uint32_t linkip) {
		playlist.SetLinkip(pc, linkip);
	}
#endif
...
#ifdef TURING_MPD_CHANGE
	virtual void OnTuringChange() override;
#endif
