...
class CdbTimer final : public TimeoutMonitor {
public:
	CdbTimer(EventLoop &_loop, int type):TimeoutMonitor(_loop), m_type(type) {}
...
extern class CdbTimer *Myctv;
extern const class Domain cdb_domain;
#endif
