		...
		Error &error)
{
	...
	if (mpd_montage != nullptr)
		av_dict_set(&opts, "montage", mpd_montage, 0);
	if (mpd_probesize != nullptr)
		av_dict_set(&opts, "probesize", mpd_probesize, 0);
	if (mpd_analyzeduration != nullptr)
		av_dict_set(&opts, "analyzeduration", mpd_analyzeduration, 0);
...
#ifdef MONTAGE_MPD_PATCH
"m3u8","m3u",
	"aac", "amr", "ape", "flac", "m4a", "mp4", "m3u8","m3u", "wav", "wma", 
	"ogg", "mp1", "mp2", "mp3", "mp4a", "oga", "asf", "ts", nullptr
#else
