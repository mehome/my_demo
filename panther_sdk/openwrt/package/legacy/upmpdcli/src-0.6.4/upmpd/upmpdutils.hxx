...
//extern std::string http_didlmake(const MpdStatus& mpds,WARTI_pMusic p,bool next = false);
//extern std::string http_didlmake(const MpdStatus& mpds,WARTI_MusicPtr p);
