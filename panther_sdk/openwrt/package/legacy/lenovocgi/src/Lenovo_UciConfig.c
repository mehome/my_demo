...
int Lenovo_UciConfig_FreeValueString(char **ppstring)
{
	int ret = 0;
...
char * Lenovo_UciConfig_SearchValueString(char *psearch)
{
	char *pretval = NULL;
	...
	else
	{
		...
		uci_set_confdir(pcontext, LENOVO_CONFIG_PATH);
...
int Lenovo_UciConfig_SearchAndSetValueString(char *psearch, char *pstring)
{
	int ret = -1;
	int find = 0;
	struct uci_context *pcontext = NULL;
	...
	else
	{
		...
		strcpy(path, LENOVO_CONFIG_PATH);
...
int Lenovo_UciConfig_SetValueString(char *psearch, char *pstring)
{
	int ret = -1;
	int find = 0;
	struct uci_context *pcontext = NULL;
