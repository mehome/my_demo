...
public:
	...
	int sendToTestTool(long int startTime, char byFlag);
...
private:
	...
	int send_broadcast_to_interface(char* buffer, char* ifname);
	int create_broadcast_socket(char* ifname);
...
private:
	...
	static unsigned int m_failRetryCount;
