...
#define SSID_PREFIX "Biu_Speaker_M"
#define FIRMWARE_PREFIX "Biu_Speaker_V1_"

#elif defined DuerOS
#define SSID_PREFIX "DuerOS_"
#define FIRMWARE_PREFIX "DuerOS_V1_"
#elif defined TuringWakeup
#define SSID_PREFIX "Tuling_"
#define FIRMWARE_PREFIX "Tuling_"
#else
...
//   eval_nowait("wavplayer /tmp/res/starting_up.wav");
    ...
    cdb_set("$charge_plug","001");
    cdb_set_int("$battery_level", 10);
    cdb_set("$ota_wifi_path","http://120.77.233.10/F8198_panther/W-KING/WIFI/");
    cdb_set("$ota_bt_path",  "http://120.77.233.10/F8198_panther/W-KING/BT/");
    cdb_set("$backup_ota_wifi_path","http://120.77.233.10/F8198_panther/W-KING/BACKUP/");
    cdb_set("$backup_ota_bt_path","http://120.77.233.10/F8198_panther/W-KING/BACKUP/");
#elif defined(CONFIG_PROJECT_K2_V1) 
#if 0			//K2é¡¹ç›®
      cdb_set("$ota_wifi_path","http://120.77.233.10/F8198_panther/K2/WIFI/");
      cdb_set("$ota_bt_path",  "http://120.77.233.10/F8198_panther/K2/BT/");
	  cdb_set("$backup_ota_wifi_path","http://120.77.233.10/F8198_panther/K2/BACKUP/");
	  cdb_set("$backup_ota_bt_path","http://120.77.233.10/F8198_panther/K2/BACKUP/");
#else			//é£žé¹¤æœºå™¨äºº
	  cdb_set("$ota_wifi_path","http://120.77.233.10/WIFI_FW_TIANTAO/wifi_test/");
      cdb_set("$ota_bt_path",  "http://120.77.233.10/WIFI_FW_TIANTAO/bt_test/");
	  cdb_set("$backup_ota_wifi_path","http://120.77.233.10/WIFI_FW_TIANTAO/BACKUP/");
      cdb_set("$backup_ota_bt_path","http://120.77.233.10/WIFI_FW_TIANTAO/BACKUP/");
#endif

#elif defined(CONFIG_PROJECT_DOSS_1MIC_V1)
	cdb_set("$ota_wifi_path","http://120.77.233.10/WIFI_DOSS_FW/wifi_FW/");
    cdb_set("$ota_bt_path",  "http://120.77.233.10/WIFI_DOSS_FW/bt_FW/");
    cdb_set("$backup_ota_wifi_path","http://120.77.233.10/WIFI_DOSS_FW/BACKUP/");
    cdb_set("$backup_ota_bt_path",  "http://120.77.233.10/WIFI_DOSS_FW/BACKUP/");
#endif
	cdb_set_int("$battery_first_state",1);
...
//    exec_cmd("setLanguage.sh init");	
	...
	wav_play_preload("/root/res/cn/starting_up.wav");	//æ­£åœ¨å¯åŠ¨ï¼Œè¯·ç¨åŽ		
