...
//usage:     "\n	-n	Do not sync"
//usage:     "\n	-f	Force (don't go through init)"
//usage:     "\n	-b	Stop at boot loader"
//usage:     "\n	-r	Restart to recovery mode"
...
int halt_main(int argc UNUSED_PARAM, char **argv)
{
	...
	flags = getopt32(argv, "d:nfwibr", &delay);
...
#define BOOT2_BOOT_FAILURE_CHECK_MAGIC2_BOOT_RECOVERY 0xFF2004FFUL
	...
	if (flags & (0x01 << 5))
	{
		system("ew b0007ff0 45A84637");
		system("ew b0007ff4 FF4002FF");
		printf("Rebooting to boot loader\n");
	}
	else if(flags & (0x01 << 6))
	{
		system("ew b0007ff0 45A84637");
		system("ew b0007ff4 FF2004FF");
