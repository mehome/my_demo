...
//#define ASR_TTS_FORMAT		SND_PCM_FORMAT_S16_BE
#define ASR_TTS_FORMAT		SND_PCM_FORMAT_S16_LE
#define ASR_TTS_SPEED		24000
#define ASR_TTS_CHANNELS	1

extern int PlayTTSAudio_Init();
extern void PlayTTSAudio_Buffer(char *buf, unsigned int count);
extern void PlayTTSAudio_Close(void);

extern void CreateWavPlayPthread(void);
