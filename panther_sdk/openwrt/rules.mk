...
ifeq ($(CONFIG_PANTHER_TOOLCHAIN),y)
ifeq ($(CONFIG_USE_MUSL),y)
CONFIG_LIBC_FILE_SPEC="./lib/ld{-*.so,-musl*.so.*,-linux*.so.*,-*.so.*} ./lib/lib{anl,c,cidn,crypt,dl,m,nsl,nss_dns,nss_files,resolv,util}{-*.so,.so.*,.so}"
ifeq ($(CONFIG_BIG_ENDIAN),y)
CONFIG_TARGET_ARCH_PACKAGES="panther-be"
CONFIG_TARGET_NAME="mips-openwrt-linux"
CONFIG_TOOLCHAIN_PREFIX="mips-openwrt-linux-"
ifeq ("$(shell test -d /opt/montage/toolchain-mips_interaptiv_gcc-7.3.0_musl && echo ex)","ex")
CONFIG_TOOLCHAIN_ROOT="/opt/montage/toolchain-mips_interaptiv_gcc-7.3.0_musl"
else
CONFIG_TOOLCHAIN_ROOT=$(TOPDIR)/../panther/toolchains/toolchain-mips_interaptiv_gcc-7.3.0_musl
endif
else
CONFIG_TARGET_ARCH_PACKAGES="panther-le"
CONFIG_TARGET_NAME="mipsel-openwrt-linux"
CONFIG_TOOLCHAIN_PREFIX="mipsel-openwrt-linux-"
ifeq ("$(shell test -d /opt/montage/toolchain-mipsel_interaptiv_gcc-7.3.0_musl && echo ex)","ex")
CONFIG_TOOLCHAIN_ROOT="/opt/montage/toolchain-mipsel_interaptiv_gcc-7.3.0_musl"
else
CONFIG_TOOLCHAIN_ROOT=$(TOPDIR)/../panther/toolchains/toolchain-mipsel_interaptiv_gcc-7.3.0_musl
endif
endif
else
ifeq ($(CONFIG_BIG_ENDIAN),y)
...
CONFIG_TARGET_NAME="mips-openwrt-linux"
CONFIG_TOOLCHAIN_PREFIX="mips-openwrt-linux-"
ifeq ("$(shell test -d /opt/montage/toolchain-mips_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2 && echo ex)","ex")
CONFIG_TOOLCHAIN_ROOT="/opt/montage/toolchain-mips_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2"
else
CONFIG_TOOLCHAIN_ROOT=$(TOPDIR)/../panther/toolchains/toolchain-mips_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2
endif
else
CONFIG_TARGET_ARCH_PACKAGES="panther-le"
CONFIG_TARGET_NAME="mipsel-openwrt-linux"
CONFIG_TOOLCHAIN_PREFIX="mipsel-openwrt-linux-"
ifeq ("$(shell test -d /opt/montage/toolchain-mipsel_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2 && echo ex)","ex")
CONFIG_TOOLCHAIN_ROOT="/opt/montage/toolchain-mipsel_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2"
else
CONFIG_TOOLCHAIN_ROOT=$(TOPDIR)/../panther/toolchains/toolchain-mipsel_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2
endif
endif
endif
