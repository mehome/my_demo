...
#define TASK_PID 496 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1384 /* sizeof(struct task_struct)	 # */
...
#define THREAD_BVADDR 1364 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 1368 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 1372 /* offsetof(struct task_struct, thread.error_code)	 # */
#define THREAD_TRAPNO 1376 /* offsetof(struct task_struct, thread.trap_nr)	 # */
...
#define VCPU_RUN 56 /* offsetof(struct kvm_vcpu, run)	 # */
#define VCPU_HOST_ARCH 264 /* offsetof(struct kvm_vcpu, arch)	 # */
...
#define VCPU_GUEST_KERNEL_ASID 1604 /* offsetof(struct kvm_vcpu_arch, guest_kernel_asid)	 # */
