...
// Pass argv for kernel module
static short btn0_gnum = -1;
static short btn1_gnum = -1;
static short btn2_gnum = -1;
static short btn3_gnum = -1;
static short btn4_gnum = -1;
static short btn5_gnum = -1;

module_param(btn0_gnum, short, 0000);
MODULE_PARM_DESC(btn0_gnum, "Button 0's GPIO number");
module_param(btn1_gnum, short, 0000);
MODULE_PARM_DESC(btn1_gnum, "Button 1's GPIO number");
module_param(btn2_gnum, short, 0000);
MODULE_PARM_DESC(btn2_gnum, "Button 2's GPIO number");
module_param(btn3_gnum, short, 0000);
MODULE_PARM_DESC(btn3_gnum, "Button 3's GPIO number");
module_param(btn4_gnum, short, 0000);
MODULE_PARM_DESC(btn4_gnum, "Button 4's GPIO number");
module_param(btn5_gnum, short, 0000);
MODULE_PARM_DESC(btn5_gnum, "Button 5's GPIO number");
/* -------------------------------------------------------------------------*/
...
static void gpio_keys_polled_check_state(struct gpio_keys_button_data *bdata)
{
	...
	if (!gpio_is_valid(bdata->b->gpio)) {
		return;
	}
	state = gpio_button_get_value(bdata);
...
static unsigned int btnn2gpio(int num)
{
	short gpio;
