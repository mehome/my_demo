...
#define DRAGONITE_ACQ_DELAY_KICK_SUPPORT
...
struct __tag_acq 
{
   ...
   volatile u16  esn;
   volatile u32  qinfo;
   volatile acqe acqe[ACQ_MAX_BUFSIZE * 2];

#if defined (DRAGONITE_ACQ_DELAY_KICK_SUPPORT)
   volatile int tx_count;
   struct hrtimer tx_acq_timer;
#endif
   u16  ampdu_len;
};
