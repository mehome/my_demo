...
#define IE_IBSS_BIT				BIT(4)
#define IE_COUNTRY_BIT			BIT(5)
#define IE_CHALLENGE_BIT		BIT(6)
#define IE_PWR_CAP_BIT			BIT(7)
#define IE_SUPPORT_CHAN_BIT		BIT(8)
#define IE_ERP_INFO_BIT			BIT(9)
#define IE_HT_CAP_BIT			BIT(10) 
#define IE_RSN_BIT				BIT(11)
#define IE_EXT_SUPP_RATES_BIT	BIT(12)
#define IE_MD_BIT				BIT(13)
#define IE_FT_BIT				BIT(14)
#define IE_TIME_OUT_BIT			BIT(15)
#define IE_HT_INFO_BIT			BIT(16)
#define IE_WAPI_BIT				BIT(17)
#define IE_EXT_CAP_BIT			BIT(18)
#define IE_WPA_BIT				BIT(19)
#define IE_WMM_BIT				BIT(20)
#define IE_WPS_BIT				BIT(21)
#define IE_P2P_BIT				BIT(22)
