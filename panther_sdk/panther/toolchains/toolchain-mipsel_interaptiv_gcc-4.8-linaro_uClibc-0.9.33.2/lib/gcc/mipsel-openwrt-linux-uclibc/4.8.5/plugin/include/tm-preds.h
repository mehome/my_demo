/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/workplace3/panther/openwrt/build_dir/toolchain-mipsel_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2/gcc-linaro-4.8-2015.06/gcc/config/mips/mips.md'.  */
