...
enum opt_code
{
  ...
  OPT_fgnu_unique = 623,                     /* -fgnu-unique */
  ...
  OPT_fplt = 780,                            /* -fplt */
  OPT_fplugin_arg_ = 781,                    /* -fplugin-arg- */
  OPT_fplugin_ = 782,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 783,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 784,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 785,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 786,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 787,                   /* -fpreprocessed */
  OPT_fpretty_templates = 788,               /* -fpretty-templates */
  OPT_fprofile = 789,                        /* -fprofile */
  OPT_fprofile_arcs = 790,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 791,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 792,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 793,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 794,              /* -fprofile-generate= */
  OPT_fprofile_report = 795,                 /* -fprofile-report */
  OPT_fprofile_use = 796,                    /* -fprofile-use */
  OPT_fprofile_use_ = 797,                   /* -fprofile-use= */
  OPT_fprofile_values = 798,                 /* -fprofile-values */
  OPT_fprotect_parens = 799,                 /* -fprotect-parens */
  OPT_frandom_seed = 800,                    /* -frandom-seed */
  OPT_frandom_seed_ = 801,                   /* -frandom-seed= */
  OPT_frange_check = 802,                    /* -frange-check */
  OPT_freal_4_real_10 = 803,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 804,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 805,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 806,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 807,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 808,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 809,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 810,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 811,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 812,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 813,                /* -frecord-marker=8 */
  OPT_frecursive = 814,                      /* -frecursive */
  OPT_freduced_reflection = 815,             /* -freduced-reflection */
  OPT_free = 816,                            /* -free */
  OPT_freg_struct_return = 817,              /* -freg-struct-return */
  OPT_fregmove = 818,                        /* -fregmove */
  OPT_frename_registers = 819,               /* -frename-registers */
  OPT_freorder_blocks = 820,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 821,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 822,              /* -freorder-functions */
  OPT_frepack_arrays = 823,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 824,           /* -freplace-objc-classes */
  OPT_frepo = 825,                           /* -frepo */
  OPT_frequire_return_statement = 826,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 827,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 828, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 829,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 830,                    /* -fresolution= */
  OPT_frounding_math = 831,                  /* -frounding-math */
  OPT_frtti = 832,                           /* -frtti */
  OPT_fsanitize_address = 833,               /* -fsanitize=address */
  OPT_fsanitize_thread = 834,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 835,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 836,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 837,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 838,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 839,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 840,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 841,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 842,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 843,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 844,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 845,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 846,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 847,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 848,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 849,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 850,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 851,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 852,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 853, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 854,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 855,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 856,              /* -fsecond-underscore */
  OPT_fsection_anchors = 857,                /* -fsection-anchors */
  /* OPT_fsee = 858, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 859,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 860,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 861, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 862,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 863,          /* -fselective-scheduling2 */
  OPT_fshort_double = 864,                   /* -fshort-double */
  OPT_fshort_enums = 865,                    /* -fshort-enums */
  OPT_fshort_wchar = 866,                    /* -fshort-wchar */
  OPT_fshow_column = 867,                    /* -fshow-column */
  OPT_fshrink_wrap = 868,                    /* -fshrink-wrap */
  OPT_fsign_zero = 869,                      /* -fsign-zero */
  OPT_fsignaling_nans = 870,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 871,               /* -fsigned-bitfields */
  OPT_fsigned_char = 872,                    /* -fsigned-char */
  OPT_fsigned_zeros = 873,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 874,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 875,               /* -fsource-filename= */
  OPT_fsource_ = 876,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 877,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 878,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 879,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 880, */                 /* -fsquangle */
  OPT_fstack_arrays = 881,                   /* -fstack-arrays */
  /* OPT_fstack_check = 882, */              /* -fstack-check */
  OPT_fstack_check_ = 883,                   /* -fstack-check= */
  OPT_fstack_limit = 884,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 885,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 886,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 887,                /* -fstack-protector */
  OPT_fstack_protector_all = 888,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 889,                   /* -fstack-reuse= */
  OPT_fstack_usage = 890,                    /* -fstack-usage */
  OPT_fstats = 891,                          /* -fstats */
  OPT_fstore_check = 892,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 893, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 894,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 895,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 896,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 897, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 898,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 899,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 900,                    /* -fsyntax-only */
  OPT_ftabstop_ = 901,                       /* -ftabstop= */
  /* OPT_ftarget_help = 902, */              /* -ftarget-help */
  OPT_ftarget_ = 903,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 904,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 905, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 906,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 907,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 908, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 909,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 910,             /* -fthreadsafe-statics */
  OPT_ftime_report = 911,                    /* -ftime-report */
  OPT_ftls_model_ = 912,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 913,               /* -ftoplevel-reorder */
  OPT_ftracer = 914,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 915,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 916,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 917,                  /* -ftrapping-math */
  OPT_ftrapv = 918,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 919,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 920,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 921,                       /* -ftree-ccp */
  OPT_ftree_ch = 922,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 923,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 924,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 925,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 926,                /* -ftree-copyrename */
  OPT_ftree_cselim = 927,                    /* -ftree-cselim */
  OPT_ftree_dce = 928,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 929,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 930,                       /* -ftree-dse */
  OPT_ftree_forwprop = 931,                  /* -ftree-forwprop */
  OPT_ftree_fre = 932,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 933,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 934,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 935,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 936,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 937,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 938,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 939, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 940,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 941,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 942,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 943,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 944,                   /* -ftree-phiprop */
  OPT_ftree_pre = 945,                       /* -ftree-pre */
  OPT_ftree_pta = 946,                       /* -ftree-pta */
  OPT_ftree_reassoc = 947,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 948, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 949,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 950,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 951,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 952,                      /* -ftree-slsr */
  OPT_ftree_sra = 953,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 954, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 955, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 956,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 957,                /* -ftree-tail-merge */
  OPT_ftree_ter = 958,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 959, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 960,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 961,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 962,                       /* -ftree-vrp */
  OPT_funderscoring = 963,                   /* -funderscoring */
  OPT_funit_at_a_time = 964,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 965,               /* -funroll-all-loops */
  OPT_funroll_loops = 966,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 967,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 968,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 969,             /* -funsigned-bitfields */
  OPT_funsigned_char = 970,                  /* -funsigned-char */
  OPT_funswitch_loops = 971,                 /* -funswitch-loops */
  OPT_funwind_tables = 972,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 973,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 974,                   /* -fuse-boehm-gc */
