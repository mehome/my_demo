...
#define CONFIG_BOOT_IP      IP_ADDR(192,168,0,108)
#define CONFIG_BOOT_SERVER  IP_ADDR(192,168,0,135)
#define CONFIG_BOOT_GW      IP_ADDR(192,168,0,1)
#define CONFIG_BOOT_MSK     IP_ADDR(255,255,255,0)
#define CONFIG_BOOT_MAC0    "\x80\x50\xDF\x00\x66\x01"
#define CONFIG_BOOT_MAC1    "\x80\x50\xDF\x00\x66\x02"
#define CONFIG_BOOT_MAC2    "\x80\x50\xDF\x00\x66\x03"
#define CONFIG_BOOT_FILE    "combined-uzImage-ubi-overlay"
...
#define CONFIG_BOOT_PINMUX      "0=5,1=5,2=0,3=0,10=5,11=5,14=5,15=5,16=5,12=0,6=4,8=4,9=4"
#define CONFIG_BOOT_DRIV_STR    "2=3,3=3,10=3,11=3,14=3,15=3,16=3"
#define CONFIG_BOOT_GPIO_SETTING   "12=0"
/* BEGIN: Modified by Frog, 2018-8-16 16:06:16*/
//#define CONFIG_BOOT_POWERCFG    0x20ffe8
//#define CONFIG_BOOT_POWERCFG    (0x20ffe8 | 0x01)  //支持U盘功能
#define CONFIG_BOOT_POWERCFG    (0x20ffe8 | 0x02)    //支持TF功能
//#define CONFIG_BOOT_POWERCFG    (0x20ffe8 | 0x01 | 0x02 )    //支持U盘、TF功能
/* END:   Modified by Frog, 2018-8-16  16:06:19*/
#define CONFIG_BOOT_CLKCFG      0x0e
#define CONFIG_BOOT_WATCHDOG_TIMER 60000 // 30sec
#define CONFIG_BOOT_MIC_GAIN_CTRL_STR    "7777"
#define CONFIG_BOOT_RF_DIFF     0
...
#define CONFIG_BOOT_AUDIO_INTERFACE "pcmwb"
#ifdef SND_SIZE
#define CONFIG_BOOT_RECOVERY 2
#define CONFIG_BOOT_RECOVERY_OFFSET   0x40000
#define CONFIG_SECOND_IMAGE_OFFSET    0xa0000
#define CONFIG_BOOT_CI_OFFSET         (0xa0000 + SND_SIZE)
#else
