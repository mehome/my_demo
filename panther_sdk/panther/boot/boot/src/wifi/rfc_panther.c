...
//    tx_mux_regs(MUX_BASEBAND, 0, 0, 0); //unsigned char tg_a_i, unsigned char tg_a_q, double ctl_coe are useless
    ...
    unsigned short tdb = (tx_avg_db>0)?((unsigned short)(tx_avg_db*1000)):((unsigned short)((-tx_avg_db)*1000)|0x8000);
    unsigned short tde = (tx_avg_degree>0)?((unsigned short)(tx_avg_degree*1000)):((unsigned short)((-tx_avg_degree)*1000)|0x8000);
    __REG_WRITE32(0x5510, (tdb<<16)|tde);

    unsigned short rdb = (rx_avg_db>0)?((unsigned short)(rx_avg_db*1000)):((unsigned short)((-rx_avg_db)*1000)|0x8000);
    unsigned short rde = (rx_avg_degree>0)?((unsigned short)(rx_avg_degree*1000)):((unsigned short)((-rx_avg_degree)*1000)|0x8000);
    __REG_WRITE32(0x5514, (rdb<<16)|rde);
#endif
